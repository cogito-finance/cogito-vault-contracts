...
contract FundVaultFactoryV3 is Test, IFundVaultEventsV3, ITestEvents {
    USDC public usdc;
    KycManager public kycManager;
    FundVaultV3Upgradeable public implementation;
    TransparentUpgradeableProxy public proxy;
    ProxyAdmin public proxyAdmin;
    FundVaultV3Upgradeable public fundVault;
    ...
    constructor() {
        ...
        fundVault = FundVaultV3Upgradeable(address(proxy));
