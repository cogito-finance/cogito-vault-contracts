...
import "../../src/utils/upgrades/ERC1404Upgradeable.sol";
import "../../src/v3/FundVaultV3Upgradeable.sol";
import "../../src/v3/interfaces/IFundVaultEventsV3.sol";
import "./helpers/FundVaultFactoryV3.sol";
import "../../src/mocks/USDC.sol";

contract VaultTestBasicV3 is FundVaultFactoryV3 {
...
contract VaultTestTransferV3 is FundVaultFactoryV3 {
...
contract VaultTestTransferNotStrictV3 is FundVaultFactoryV3 {
    function setUp() public {
        alice_deposit(100_000e6);
...
contract VaultTestDeposit3 is FundVaultFactoryV3 {
...
contract VaultTestBalancesV3 is FundVaultFactoryV3 {
    function setUp() public {
        alice_deposit(100_000e6);
    }
...
contract VaultTestBetweenOperations is FundVaultFactoryV3 {
